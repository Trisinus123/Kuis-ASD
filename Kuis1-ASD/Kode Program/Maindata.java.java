...
public class MainData{
    public static void main(String[] args){
        ...
        System.out.println("====SIMULASI KEBUTUHNA HIDUP MASNUSIA====");
        ...
        while(i<1){
            ...
            int b = sc.nextInt();
            sc.nextLine();
            System.out.println("Apakah makanan tersebut perlu ditambahkan bumbunya? (y/n)");
            ...
            System.out.println("\nApakah ingin mengulangi data aktivitas penduduk?(y/t)");
        ...
        sc.close();
        System.out.println("\n\nSIMULASI BERAKHIR, TERIMA KASIH");
    }
}